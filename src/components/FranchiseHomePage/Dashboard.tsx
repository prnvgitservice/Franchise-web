...
const Dashboard: React.FC = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (earningsRes?.success && Array.isArray(earningsRes?.result)) {
          ...
          earningsRes.result.forEach((item: FranchiseAccount) => {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto p-4 sm:p-6">
      <div className="bg-gradient-to-r from-indigo-600 to-teal-500 rounded-2xl p-6 text-white relative overflow-hidden shadow-lg">
            ...
            <div className="h-[350px]">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  ...
                  <Tooltip
                    formatter={(value, name) => [`${value} technicians`, name]}
                    contentStyle={{
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {subscriptionData.map((item, index) => (
                  <div
                    key={index}
                    className="flex flex-col p-4 rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-300 hover:scale-105"
