...
import { getAllPincodes, franchiseRegister } from '../../api/apiMethods'; // Added franchiseRegister import
  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        const payload = {
          username: formData.username, // Fixed from formData.name
          phoneNumber: formData.phoneNumber, // Fixed from formData.mobile
        ...
        setError(err?.data?.error?.[0] || err?.message || 'Registration failed. Please try again.');
      } finally {
        setLoading(false);
      }
    },
  ...
  return (
    <main className="mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto">
        <h2 className="text-2xl font-semibold mb-6 text-center">Sign Up as Franchise</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {[
            { id: 'username', label: 'Name', type: 'text' }, // Changed id from 'name' to 'username'
            { id: 'phoneNumber', label: 'Phone Number', type: 'tel', pattern: '[0-9]{10}' }, // Changed id from 'mobile'
            ...
            { id: 'areaName', label: 'Area', type: 'text' },
      ...
      <p className="mt-4 text-sm text-center text-gray-600">
        Already signed up?{' '}
        <a href="/login/franchise" className="text-blue-600 hover:underline font-medium ms-1">
          Sign In
        </a>
      </p>
    </main>
