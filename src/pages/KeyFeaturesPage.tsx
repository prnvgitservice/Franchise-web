  ...
  return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-gray-800">
        ...
        <section className="mb-10">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">Build a Profile Page as Powerful as a Website:</h3>
          ...
          <p className="mb-2">Our platform adapts to your needs, whether part-time or full-time, supporting work-life balance.</p>
        ...
        <section className="mb-10">
          <h3 className="text-xl font-semibold text-gray-900 mb-2">KEY FEATURES FOR PROFESSIONALS:</h3>
        ...
        <section className="mb-10">
          <h3 className="text-xl font-semibold text-gray-900 mb-2">KEY FEATURES FOR ADVERTISERS:</h3>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Join as an Advertiser</strong>: Promote your business via PRNV Services.</li>
            <li><strong>Subscription Options</strong>: Advertise within chosen pin codes in GHMC limits.</li>
            <li><strong>Dedicated Profile Page</strong>: Full business info on your own profile page.</li>
            <li><strong>Featured Placement</strong>: Featured listings based on plan type.</li>
            <li><strong>Early Joiner Advantage</strong>: Get listed at the top.</li>
            <li><strong>Plan Validity and Renewal</strong>: 30-day plans, renewable.</li>
            <li><strong>Additional Digital Marketing</strong>: Share your profile for more visibility.</li>
            <li><strong>Refund policy</strong>: No refund applicable.</li>
          </ul>
          <div className="bg-yellow-100 text-yellow-800 p-4 mt-4 rounded-md font-medium">
            <strong>PLEASE NOTE:</strong> THE ABOVE FEATURES ARE SUBJECT TO OUR ADVERTISING POLICIES.
          </div>
        </section>

        <section className="mb-10">
          <h3 className="text-xl font-semibold text-gray-900 mb-2">KEY FEATURES FOR CUSTOMERS:</h3>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Commission-Free</strong>: No extra cost to customers.</li>
            <li><strong>Competitive Pricing</strong>: Enjoy lowest market rates.</li>
            <li><strong>Rating and Reviews</strong>: Help improve services via feedback.</li>
            <li><strong>Damage and Work Guarantee</strong>: One-week guarantee & damage coverage if customer details are submitted.</li>
            <li><strong>GST Exemption</strong>: Most providers are GST-free.</li>
            <li><strong>Repeat Hiring</strong>: Hire the same professional again.</li>
            <li><strong>Choice and Bargaining</strong>: Freedom to choose and negotiate.</li>
            <li><strong>Refund Policy</strong>: Not applicable for Service Providers.</li>
          </ul>
        </section>

        <section className="mb-10">
          <h3 className="text-xl font-semibold text-gray-900 mb-2">Why Join as a Business Development Associate (BDA)?</h3>
          <p className="mb-2"><strong>'RECURRING INCOME'</strong> is one of the best advantages of the BDA plan...</p>
          <p className="mb-2"><strong>Example:</strong> If a BDA introduces one technician under ₹3000 plan, they'll earn ₹300 on join + renewal.</p>
          <p className="mb-4">Initially small, over time this becomes a great source of recurring income.</p>
          <div className="bg-red-100 text-red-800 p-4 rounded-md font-medium">
            <strong>NOTE:</strong> BDA monthly fee is non-refundable.
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="bg-blue-100 text-blue-800 p-4 mt-4 rounded-md font-medium">
